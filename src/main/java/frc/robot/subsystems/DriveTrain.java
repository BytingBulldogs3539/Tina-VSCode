...
public class DriveTrain extends Subsystem
{
        ...
        public TalonSRX fr, fl, br, bl, pigeon;
        public Drive drive;
        ...
        public DriveTrain()
        {
                ...
                pigeon = new TalonSRX(8);

                _imu = new PigeonIMU(pigeon);
        ...
        public void initMotionProfile()
        {
                ...
                if (MotionProfileConstants.kHeadingSensorChoice == 0)
                {
                        ...
                        fr.configSelectedFeedbackSensor(FeedbackDevice.SensorDifference,
                                        MotionProfileConstants.PID_TURN, MotionProfileConstants.kTimeoutMs);

                        /* do not scale down the primary sensor (distance) */
                        fr.configSelectedFeedbackCoefficient(1, MotionProfileConstants.PID_PRIMARY,
                                        MotionProfileConstants.kTimeoutMs);
                        ...
                        fr.configSelectedFeedbackCoefficient(
                                        MotionProfileConstants.kTurnTravelUnitsPerRotation
                                                        / MotionProfileConstants.kEncoderUnitsPerRotation,
                                        MotionProfileConstants.PID_TURN, MotionProfileConstants.kTimeoutMs);
                }
                else
                {
                         ...
                         */
                        fr.configSelectedFeedbackCoefficient(1.0, MotionProfileConstants.PID_PRIMARY,
                                        MotionProfileConstants.kTimeoutMs);
                        ...
                        fr.configSelectedFeedbackCoefficient(
                                        MotionProfileConstants.kTurnTravelUnitsPerRotation
                                                        / MotionProfileConstants.kPigeonUnitsPerRotation,
                                        MotionProfileConstants.PID_TURN, MotionProfileConstants.kTimeoutMs);
                }
                ...
                fr.config_kF(MotionProfileConstants.kSlot_Distanc, MotionProfileConstants.kGains_Distanc.kF,
                                MotionProfileConstants.kTimeoutMs);
                fr.config_IntegralZone(MotionProfileConstants.kSlot_Distanc,
                                (int) MotionProfileConstants.kGains_Distanc.kIzone, MotionProfileConstants.kTimeoutMs);
                ...
                fr.config_kF(MotionProfileConstants.kSlot_Turning, MotionProfileConstants.kGains_Turning.kF,
                                MotionProfileConstants.kTimeoutMs);
                fr.config_IntegralZone(MotionProfileConstants.kSlot_Turning,
                                (int) MotionProfileConstants.kGains_Turning.kIzone, MotionProfileConstants.kTimeoutMs);
                ...
                fr.config_kF(MotionProfileConstants.kSlot_MotProf, MotionProfileConstants.kGains_MotProf.kF,
                                MotionProfileConstants.kTimeoutMs);
                fr.config_IntegralZone(MotionProfileConstants.kSlot_MotProf,
                                (int) MotionProfileConstants.kGains_MotProf.kIzone, MotionProfileConstants.kTimeoutMs);
                ...
                fr.config_kF(MotionProfileConstants.kSlot_Velocit, MotionProfileConstants.kGains_Velocit.kF,
                                MotionProfileConstants.kTimeoutMs);
                fr.config_IntegralZone(MotionProfileConstants.kSlot_Velocit,
                                (int) MotionProfileConstants.kGains_Velocit.kIzone, MotionProfileConstants.kTimeoutMs);
                ...
                fr.configSetParameter(ParamEnum.ePIDLoopPeriod, closedLoopTimeMs, 0x00,
                                MotionProfileConstants.PID_PRIMARY, MotionProfileConstants.kTimeoutMs);
